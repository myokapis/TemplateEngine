...
namespace TemplateEngine.Tests.DocumentTests
{
    ...
    public class SectionInfoTests
    {
        ...
        {
            var sectionInfo = new SectionInfo("Section1", 13, "OpenTag1", "prefix", "suffix", false);
        ...
        {
            var sectionInfo = new SectionInfo("Section1", 13, "OpenTag1", "prefix", "suffix", false, 69);
        ...
        {
            var exception = Record.Exception(() => new SectionInfo("Section1", -1, "OpenTag1", "prefix", "suffix", false, 69));
        ...
        {
            var sectionInfo = new SectionInfo("Section1", 13, "OpenTag1", "prefix", "suffix", false, 12);
