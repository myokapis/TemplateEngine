...
namespace TemplateEngine.Tests.Models
{
    ...
    internal class FormatterTestInfo
    {
        ...
        public DateTimeFormatInfo DateFormatter { get; set; } = CultureInfo.CurrentCulture.DateTimeFormat;
        ...
        public NumberFormatInfo NumberFormatter { get; set; } = CultureInfo.CurrentCulture.NumberFormat;
